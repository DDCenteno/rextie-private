...
const validateResult = () => {
  ...
  <div className="mb-3">
    ...
    <div className="border radius-20 p-4 w600 m-auto">
    ...
    <div className="text-center mt-3">
      <a  className="btn next radius-20 white bg-grey-2 mr-2" href="#/converter"  onClick={() => OnNavigateReset('converter')} >Cambiar la cantidad</a>
